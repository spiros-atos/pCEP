...
// spiros
const int QUAD_REG_LEN = 20;	// number of elements to use for calculating future pred
//const int QUAD_REG_LEN = 5;	// number of elements to use for calculating future pred
const int QUAD_REG_OFFSET = 10;
